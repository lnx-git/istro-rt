...
mingw32-g++ -Wall -I"C:\Programs\opencv3\include" istro_rt2019.cpp -L"C:\Programs\opencv3\x86\mingw\staticlib" ctrlboard.o lidar.o camera.o system.o vision.o mtime.o sample.o dataset.o threads.o logger.o gpsdev.o geocalc.o myahrs.o config.o navig.o navig_data.o dmap.o wmodel.o qrscan.o navmap.o navmap_data.o -lopencv_highgui342 -lopencv_imgcodecs342 -lopencv_imgproc342 -lopencv_core342 -lzlib -llibjpeg-turbo -llibwebp -llibpng -llibtiff -lgdi32 -lpthread -lcomdlg32 -o istro_rt2019
@rem  > __log 2> __err
