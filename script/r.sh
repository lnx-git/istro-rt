...
if [ -z "$CB_OUT" ]; then
	...
	CMD=$CMD" -cb /dev/arduino1"
fi

CMD=$CMD" -cb2 /dev/ttyUSB3" 
...
rm /home/pi/projects/robotour2016/istro_rt2016/out/istro_rt2016.log

sudo killall gpspipe
rm /home/pi/projects/robotour2016/istro_rt2016/out/gpspipe.log
