...
const int   LIDAR_QUALITY_DMAP       =   2; //13;    // ignore obstacles (to filter sun reflection) if quality is below (<13); 2=ignore
const int   LIDAR_QUALITY_STOP       =   3; //20;    // ignore stop condition (to filter sun reflection) if quality is below (<20); 3=ignore
